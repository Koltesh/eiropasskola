...
const whyCards = [
  {
    ...
    desc: "ETV atestāts ļauj iestāties jebkurā Latvijas vai ārvalstu augstskolā.",
  },
  {
    icon: GraduationCap,
    title: "Sagatavošanās eksāmeniem",
    desc: "Konsultācijas un papildu nodarbības, lai eksāmeniem gatavotos ar pārliecību.",
  },
  {
    icon: Compass,
    title: "Karjeras konsultants",
    desc: "Palīdzam saprast, kurš virziens atbilst taviem nākotnes plāniem.",
  },
];

const prizes = [
  { icon: Laptop, month: "Jūnijs", prize: "MacBook Neo" },
  { icon: Smartphone, month: "Jūlijs", prize: "iPhone 17e" },
  { icon: Headphones, month: "Augusts", prize: "3x AirPods" },
];
...
const testimonials = [
  {
    quote: "Tālmācība ļāva man apvienot mācības ar treniņiem. Skolotāji vienmēr atbalsta un palīdz sagatavoties eksāmeniem.",
    name: "Marta",
    meta: "11. klase, IT virziens",
  },
  {
    quote: "Patīk, ka varu mācīties savā tempā. Materiāli ir skaidri, un konsultācijas tiešām palīdz saprast grūtākās tēmas.",
    name: "Roberts",
    meta: "12. klase, Dabaszinātnes",
  },
  {
    quote: "Karjeras konsultants palīdzēja izvēlēties studiju virzienu. Jūtos pārliecināta par nākotni.",
    name: "Elīza",
    meta: "10. klase, Uzņēmējdarbība",
  },
];

const VasarasKampana = () => {
  return (
    <div className="min-h-screen bg-[hsl(40_40%_98%)] text-foreground font-sans">
        ...
        <div className="container mx-auto relative z-10 max-w-6xl px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight">
              Iegūsti izglītību, kas atver durvis uz nākotni —{" "}
              <span className="text-primary">un laimē vēl šovasar</span>
            </h1>
            <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto">
              6 specializētas mācību programmas. Akreditēta skola. Piesakies tagad un piedalies vasaras balvu izlozē.
            </p>
      ...
      {/* PROGRAMS */}
      <section id="programmas" className="py-20 lg:py-28">
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center max-w-2xl mx-auto mb-10 space-y-3">
            ...
            <h2 className="font-display text-3xl lg:text-4xl font-bold">
              Piesakies ETV un laimē visu vasaru
            </h2>
            <p className="text-muted-foreground">
              Katru vasaras mēnesi izlozējam vienu balvu starp jaunajiem ETV skolēniem, kas noslēguši mācību līgumu.
            </p>
          </div>
